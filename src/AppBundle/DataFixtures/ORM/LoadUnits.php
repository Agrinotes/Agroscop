...
class LoadUnits extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $names = array(
            ...
            array('luminous_intensity','Candela','candela','1','','','cd'),
            ...
            array('mass_area_density','Grammes par mètre carré','gram_per_square_meter','0.001','','1','g/m²'),
            ...
            array('mass','Kilogrammes','kilogram','1','','','kg'),
            array('mass_area_density','Kilogrammes par hectare','kilogram_per_hectare','1','','10000.0','kg/ha'),
            ...
            array('mass_area_density','Kilogrammes par mètre carré','kilogram_per_square_meter','1','','1','kg/m²'),
            ...
            array('volume_area_density','Litres par mètre carré','liter_per_square_meter','0.001','','1','L/m²'),
            array('power','Mégawatt','megawatt','1000000.0','','','MW'),
            array('distance','Mètres','meter','','','','m'),
            array('surface_area','Mètres carré','square_meter','','','','m²'),
            array('volume','Mètres cube','cubic_meter','1','','','m³'),
            array('volume_area_density','Mètres cube par hectare','cubic_meter_per_hectare','1','','10000.0','m³/ha'),
            array('volume_area_density','Centimètres cube par hectare','cubic_centimeter_per_hectare','1.0e-06','','10000.0','cm³/ha'),
            ...
            array('none','Unités','unity','','','','au total'),
            array('surface_area_density','Unité par hectare','unity_per_hectare','','','10000.0','par ha'),
            array('mass_density','Unité par kilogramme','unity_per_kilogram','','','','par kg'),
            array('concentration','Unité par litre','unity_per_liter','','','0.001','par L'),
            array('surface_area_density','Unité par mètre carré','unity_per_square_meter','','','','par m²'),
